...
namespace ReelJett.Persistence.Migrations
{
    ...
    [Migration("20240914155437_configurationsadd")]
    partial class configurationsadd
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ReelJett.Domain.Entities.Concretes.ProffesionalMovie", b =>
                {
                    ...
                    b.Property<string>("MultipleUrl")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("TRAltyazi")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("TRDublaj")
                        .HasColumnType("nvarchar(max)");
